...
import com.hltc.umengpush.android.AndroidFilecast;
import com.hltc.umengpush.android.AndroidGroupcast;
import com.hltc.umengpush.android.AndroidUnicast;
import com.hltc.umengpush.ios.IOSBroadcast;
import com.hltc.umengpush.ios.IOSCustomizedcast;
import com.hltc.umengpush.ios.IOSFilecast;
import com.hltc.umengpush.ios.IOSGroupcast;
import com.hltc.umengpush.ios.IOSUnicast;
...
public class Demo {
	...
	public void sendIOSCustomizedcast() throws Exception {
		...
		// And if you have many alias, you can also upload a file containing these alias, then 
		// use file_id to send customized notification.
		customizedcast.setPredefinedKeyValue("alias", "13016428782");
		// TODO Set your alias_type here
		customizedcast.setPredefinedKeyValue("alias_type", "TYPEUID");
		customizedcast.setPredefinedKeyValue("alert", "asdfasdfasdf");
	...
	public static void main(String[] args) {
		...
		Demo demo = new Demo("551cdcb6fd98c58835000b49", "wqf6bxt3cyrdb6abfwiy0octzqef06m4");
		try {
