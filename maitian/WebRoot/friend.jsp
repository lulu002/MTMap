    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="grain">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="panel panel-primary one-way hidden">
                    ...
                    <div class="panel panel-primary double-way">
                      ...
                      <div class="panel-body">
                        <div class="input-group">
                          <span class="input-group-addon" id="sizing-addon2">A</span>
                          <input type="text" class="form-control userIdA" placeholder="用户A的userId" aria-describedby="sizing-addon2">
                        </div>
                        <div class="mt20"></div>
                        <div class="input-group">
                          <span class="input-group-addon" id="sizing-addon2">B</span>
                          <input type="text" class="form-control userIdB" placeholder="用户B的userId" aria-describedby="sizing-addon2">
                        </div>
                        <div class="mt20"></div>
                        <button type="button" class="btn btn-default fr mr20">添加</button>
                        <div class="alert alert-danger fl p6 mb0 tip-info" role="alert">info</div>
                      </div>
                    </div>                    
                </div>
                <!-- /.row -->
